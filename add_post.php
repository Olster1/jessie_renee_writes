...
//note this should be a helper function that you van just call getHtmlBuffer();
var htmlBuffer = "";
  function processForm(e) {
      //if (e.preventDefault) e.preventDefault();
      var formElm = document.getElementById("formToSend");
  	  var htmlValues = document.getElementById("text");
  	  htmlValues.value = htmlBuffer;
      return true;
  }
...
window.onload = function() {
  ...
  function setValue() {
  	var formElm = document.getElementById("formToSend");
  	var htmlValues = document.getElementById("htmlValues");
  	htmlValues.value = htmlBuffer;
  	console.log("john");
    //formElm.submit();
  }
